...
WORKTREE = Path('/private/tmp/pycbc-torch-docs-cleanup-20260908')
RUNTIME = args.runtime.resolve()
FROZEN = args.runtime_hash
DOC_BASE = '7a72fba101b80467ebcdabe33ee973b9816094fb'
...
result = dict(command=command, returncode=code, pages=pages, runtime=provenance,
              ...
              source_mapping='Ten documentation-only changes from PR15 7a72fba. API imports use the measured 88878b1c38 runtime, whose non-documentation tree is byte-identical to the cleaned main tree.',
