...
def squared_norm(self):
    ...
    if tensor.is_complex():
        if (
            ...
            # Avoid a length-two reduction for long CPU vectors. Keep both
            # squares and their sum in the input's real precision.
            out = tensor.real.square() + tensor.imag.square()
        else:
