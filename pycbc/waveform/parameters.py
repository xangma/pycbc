...
class Parameter(str):
    ...
    def __new__(
        cls, name, dtype=None, default=None, label=None, description="No description."
    ):
...
spin1x = Parameter(
    ...
    default=0.0,
    label=r"$\chi_{1x}$",
    description="The x component of the first binary component's dimensionless spin.",
)
spin1y = Parameter(
    "spin1y",
    dtype=float,
    default=0.0,
    label=r"$\chi_{1y}$",
    description="The y component of the first binary component's dimensionless spin.",
)
spin1z = Parameter(
    "spin1z",
    dtype=float,
    default=0.0,
    label=r"$\chi_{1z}$",
    description="The z component of the first binary component's dimensionless spin.",
)
spin2x = Parameter(
    "spin2x",
    dtype=float,
    default=0.0,
    label=r"$\chi_{2x}$",
    description="The x component of the second binary component's dimensionless spin.",
)
spin2y = Parameter(
    "spin2y",
    dtype=float,
    default=0.0,
    label=r"$\chi_{2y}$",
    description="The y component of the second binary component's dimensionless spin.",
)
spin2z = Parameter(
    "spin2z",
    dtype=float,
    default=0.0,
    label=r"$\chi_{2z}$",
    description="The z component of the second binary component's dimensionless spin.",
)
eccentricity = Parameter(
    "eccentricity", dtype=float, default=0.0, label=r"$e$", description="Eccentricity."
)
...
mchirp = Parameter(
    "mchirp",
    dtype=float,
    label=r"$\mathcal{M}~(\mathrm{M}_\odot)$",
...
mtotal = Parameter(
    "mtotal",
    dtype=float,
    label=r"$M~(\mathrm{M}_\odot)$",
    description="The total mass of the binary (in solar masses).",
)
q = Parameter(
    "q", dtype=float, label=r"$q$", description="The mass ratio, m1/m2, where m1 >= m2."
)
srcmass1 = Parameter(
    "srcmass1",
    dtype=float,
...
srcmchirp = Parameter(
    ...
    description="The chirp mass of the binary in the source frame (in solar masses).",
)
srcmtotal = Parameter(
    "mtotal",
    dtype=float,
    label=r"$M^{\rm{src}}~(\mathrm{M}_\odot)$",
    description="The total mass of the binary in the source frame (in solar masses).",
)
primary_mass = Parameter(
    "primary_mass",
    dtype=float,
    label=r"$m_{1}$",
    description="Mass of the primary object (in solar masses).",
)
secondary_mass = Parameter(
    "secondary_mass",
    dtype=float,
    label=r"$m_{2}$",
...
spin_px = Parameter(
    ...
    dtype=float,
    label=r"$\chi_{1x}$",
    description="The x component of the dimensionless spin of the primary object.",
)
spin_py = Parameter(
    "spin_py",
    dtype=float,
    label=r"$\chi_{1y}$",
    description="The y component of the dimensionless spin of the primary object.",
)
spin_pz = Parameter(
    "spin_pz",
    dtype=float,
    label=r"$\chi_{1z}$",
    description="The z component of the dimensionless spin of the primary object.",
)
spin_sx = Parameter(
    "spin_sx",
    dtype=float,
    label=r"$\chi_{2x}$",
    description="The x component of the dimensionless spin of the secondary object.",
)
spin_sy = Parameter(
    "spin_sy",
    dtype=float,
    label=r"$\chi_{2y}$",
    description="The y component of the dimensionless spin of the secondary object.",
)
spin_sz = Parameter(
    "spin_sz",
    dtype=float,
    label=r"$\chi_{2z}$",
    description="The z component of the dimensionless spin of the secondary object.",
)
lambda1 = Parameter(
    "lambda1",
    dtype=float,
...
delta_f = Parameter(
    ...
    default=None,
    label=r"$\Delta f$ (Hz)",
    description="The frequency step used to generate the waveform (in Hz).",
)
delta_t = Parameter(
    "delta_t",
    dtype=float,
    default=None,
    label=r"$\Delta t$ (s)",
    description="The time step used to generate the waveform (in s).",
)
sample_points = Parameter(
    "sample_points",
    dtype="Array",
    default=None,
    label=None,
...
remnant_mass = Parameter(
    "remnant_mass",
    dtype=float,
    label=r"$m_{\mathrm{rem}}$",
...
thetajn = Parameter(
    ...
    default=0.0,
    label=r"$\theta_{JN}$",
    description="The angle between the total angular momentum J and the line-of-sight.",
)
long_asc_nodes = Parameter(
    "long_asc_nodes",
    dtype=float,
    default=0.0,
    label=r"$\Omega$",
...
dec = Parameter(
    "dec", dtype=float, default=0.0, label=r"$\delta$", description="Declination (rad)."
)
...
redshift = Parameter(
    "redshift", dtype=float, default=None, label=r"$z$", description="Redshift."
)
comoving_volume = Parameter(
    "comoving_volume",
    dtype=float,
    label=r"$V_C~(\rm{Mpc}^3)$",
    description="Comoving volume (in cubic Mpc).",
)
eclipticlatitude = Parameter(
    "eclipticlatitude",
    dtype=float,
    default=0.0,
    label=r"$\beta$",
...
#
delta_fs = Parameter(
    "calib_delta_fs", dtype=float, description="Change in optical spring freq (Hz)."
)
delta_fc = Parameter(
    "calib_delta_fc", dtype=float, description="Change in cavity pole freq (Hz)."
)
delta_qinv = Parameter(
    "calib_delta_qinv", dtype=float, description="Change in inverse quality factor."
)
kappa_c = Parameter("calib_kappa_c", dtype=float)
kappa_tst_re = Parameter("calib_kappa_tst_re", dtype=float)
kappa_tst_im = Parameter("calib_kappa_tst_im", dtype=float)
kappa_pu_re = Parameter("calib_kappa_pu_re", dtype=float)
kappa_pu_im = Parameter("calib_kappa_pu_im", dtype=float)

#
#   Non mandatory flags with default values
#
frame_axis = Parameter(
    "frame_axis",
    dtype=int,
    default=0,
    description="Allow to choose among orbital_l, view and total_j",
)
modes_choice = Parameter(
    "modes_choice",
    dtype=int,
    default=0,
    description="Allow to turn on  among orbital_l, view and total_j",
)
side_bands = Parameter(
    "side_bands", dtype=int, default=0, description="Flag for generating sidebands"
)
mode_array = Parameter(
    "mode_array",
    dtype=list,
    default=None,
...
location_params = ParameterList(
    [tc, ra, dec, polarization, eclipticlatitude, eclipticlongitude]
)
...
flags_generation_params = ParameterList(
    [frame_axis, modes_choice, side_bands, mode_array]
)

# the following are parameters needed to generate an FD or TD waveform that
# is equally sampled
common_gen_equal_sampled_params = (
    ParameterList([f_lower]) + common_generation_params + flags_generation_params
)

# the following are parameters that can be used to generate an FD waveform
fd_waveform_params = (
    cbc_rframe_params
    + ParameterList([delta_f])
    + common_gen_equal_sampled_params
    + ParameterList([f_final, f_final_func])
)

# the following are parameters that can be used to generate a TD waveform
td_waveform_params = (
    cbc_rframe_params
    + ParameterList([delta_t])
    + common_gen_equal_sampled_params
    + ParameterList([numrel_data])
...
fd_waveform_sequence_params = (
    cbc_rframe_params
    + ParameterList([sample_points])
