...
def main():
    ...
    parser.add_argument('--mode', choices=['timing', 'qualify', 'cprofile', 'perf', 'torchprofile'],
                        default='timing')
    ...
    elif args.mode == 'torchprofile':
        command = [sys.executable, str(root / 'profile-inspiral-torch.py'),
                   '--output-dir', str(out / 'torch-profile'), '--', *cli]
    ...
    if args.mode == 'qualify':
        ...
        inputs.append(root / 'profile-inspiral-torch.py')
