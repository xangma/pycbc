...
Checks:
- Waveform Generation: TaylorF2, IMRPhenomD, IMRPhenomXAS, IMRPhenomXHM, IMRPhenomXP, IMRPhenomXPHM
...
def test_waveform_parity(have_cuda: bool = True):
    ...
    test_cases = [
        ("TaylorF2", {"mass1": 1.4, "mass2": 1.4, "spin1z": 0.05, "spin2z": -0.05, "f_lower": 20.0, "delta_f": 0.25}),
        ("IMRPhenomD", {"mass1": 30.0, "mass2": 25.0, "spin1z": 0.4, "spin2z": -0.3, "f_lower": 20.0, "delta_f": 0.25}),
        ("IMRPhenomXAS", {"mass1": 35.0, "mass2": 20.0, "spin1z": 0.5, "spin2z": -0.4, "f_lower": 20.0, "f_ref": 20.0, "delta_f": 0.25}),
        ("IMRPhenomXHM", {"mass1": 40.0, "mass2": 15.0, "spin1z": 0.3, "spin2z": -0.2, "inclination": 0.8, "coa_phase": 0.0, "f_lower": 20.0, "f_ref": 20.0, "delta_f": 0.25}),
        ("IMRPhenomXP", {"mass1": 35.0, "mass2": 20.0, "spin1x": 0.2, "spin1y": 0.1, "spin1z": 0.3, "spin2x": -0.1, "spin2y": 0.05, "spin2z": -0.2, "inclination": 0.7, "coa_phase": 0.0, "f_lower": 20.0, "f_ref": 20.0, "delta_f": 0.25}),
        ("IMRPhenomXPHM", {"mass1": 35.0, "mass2": 20.0, "spin1x": 0.2, "spin1y": 0.1, "spin1z": 0.3, "spin2x": -0.1, "spin2y": 0.05, "spin2z": -0.2, "inclination": 0.7, "coa_phase": 0.0, "f_lower": 20.0, "f_ref": 20.0, "delta_f": 0.25}),
    ]
