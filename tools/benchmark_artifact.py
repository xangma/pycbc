...
def runtime_metadata() -> dict:
    """Collect runtime and accelerator identity without requiring external frameworks."""
    ...
    metadata["hardware"] = {
        ...
        "accelerators": metadata["accelerator_devices"],
    }
    metadata["software"] = {
        "python": {
