...
def _run_single_case(
    ...
    if use_compressed_waveforms:
        ...
        if arm in ("torch_cuda_lal", "torch_cuda"):
...
def main():
    ...
    if args.track == "track1":
        ...
        if args.arms == list(DEFAULT_ARMS):
            args.arms = ["original_cpu", "branch_cpu", "torch_cpu", "torch_cuda_lal", "torch_cuda_diffgw"]
    ...
    orderings = [
        ["original_cpu", "branch_cpu", "torch_cpu", "torch_cuda_lal", "torch_cuda", "torch_cuda_diffgw"],
        ["torch_cuda_diffgw", "torch_cuda", "torch_cuda_lal", "torch_cpu", "branch_cpu", "original_cpu"],
        ["branch_cpu", "torch_cuda_lal", "torch_cuda_diffgw", "original_cpu", "torch_cuda", "torch_cpu"],
    ]
