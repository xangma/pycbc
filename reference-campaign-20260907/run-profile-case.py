...
def main():
    ...
    parser.add_argument('--mode', choices=['timing', 'qualify', 'cprofile', 'perf', 'filter-cprofile', 'filter-perf'],
                        default='timing')
    ...
    if args.mode == 'qualify':
        ...
        command = ['perf', 'record', '-F', '199', '-e', 'cycles:u',
                   ...
                   '--', *command]
    elif args.mode in ('filter-cprofile', 'filter-perf'):
    ...
    if args.mode in ('filter-cprofile', 'filter-perf'):
