...
Depends on [#11](https://github.com/xangma/pycbc/pull/11). PR #20 is withdrawn from this stack.

Base: `torch-pr7-taylorf2`. Head: `torch-pr8-domain-compat` at `c55f151be551bad01974f77beed7c384845ca1cb`.
