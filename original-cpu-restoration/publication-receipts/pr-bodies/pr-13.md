Evaluate detector geometry with Torch-backed values.
...
Projecting Torch waveforms requires detector delays and antenna responses that accept tensor-valued sky coordinates and times.

## Contents

Detector location and timing, antenna response and projection using the existing public detector interface.

## Links to any issues or associated PRs

Depends on [#12](https://github.com/xangma/pycbc/pull/12). PR #20 is withdrawn from this stack.

Base: `torch-pr8-domain-compat`. Head: `torch-pr9-detector` at `86f27da509f91c90a8e6c78db025b43e7a32444e`.
