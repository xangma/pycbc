...
No benchmark measurements or performance plots are bundled with the Torch
implementation. Performance claims require raw measurements and provenance
for the exact source revision under review.

The distinction between substantiated measurements, derived plots, reference
snapshots, and required evidence is defined in :ref:`torch-performance`.
