...
project = "PyCBC"
copyright = "2015, 2016, 2017, Alexander Nitz, Ian Harry, Christopher M. Biwer, Duncan A.  Brown, Josh Willis, and Tito Dal Canton"
...
# documentation.
html_theme_options = {
    "style_nav_header_background": "linear-gradient(0deg, rgba(0,0,0,1) 0%, rgba(193,193,255,1) 85%)",
    "logo_only": True,
}
...
# of the sidebar.
html_logo = (
    "https://raw.githubusercontent.com/gwastro/pycbc-logo/master/pycbc_logo_name.png"
)
...
latex_documents = [
    ("index", "PyCBC.tex", "PyCBC Documentation", "Alexander Nitz", "manual"),
]
...
man_pages = [("index", "pycbc", "PyCBC Documentation", ["Alexander Nitz"], 1)]
