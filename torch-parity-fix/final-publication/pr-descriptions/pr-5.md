...
A private compatibility helper admits ordinary contiguous single-precision Torch CPU/CUDA arrays and safely enters/restores the CPU processing context for compatibility work. Autograd, inference, special views and unsupported tensor types retain their existing fallback paths. This enables the owning PSD, filter and search PRs to reproduce original CPU arithmetic.

## Links to any issues or associated PRs

Depends on [#18](https://github.com/xangma/pycbc/pull/18). PR #20 remains withdrawn.

Base: `torch-formatting-base`. Head: `torch-pr1-runtime` at `717efb02512ed30d7e5556dee7aba67c6787df2b`.
...
Owning-branch runtime tests: **36 passed, 1 skipped**.
