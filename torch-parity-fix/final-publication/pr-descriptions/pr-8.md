...
Compatible single-precision Torch search uses NumPy's serial float32 template-power scan and the unchanged compiled CPU point chi-square routine. This preserves the original discrete bin edges, phase rounding, accumulation and normalization. Ordinary CPU arithmetic is unchanged. CUDA compatibility uses synchronous host transfers; no speedup is claimed. Unsupported tensor semantics and tensor normalization retain the generic Torch route, including stream-ordered normalization and optional output buffers.

## Links to any issues or associated PRs

Depends on [#7](https://github.com/xangma/pycbc/pull/7). PR #20 remains withdrawn.

Base: `torch-pr3-psd`. Head: `torch-pr4-filtering` at `cee69638ac44980e5235bdf8695c97e3e397b5d5`.
...
Owning-branch filter/veto tests: **113 passed, 45 skipped**.
