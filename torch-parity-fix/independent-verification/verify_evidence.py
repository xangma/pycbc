...
V2 = '88878b1c38c952e63002b812058a0c7316123f70'
...
def main():
    result = verify(O / 'remote', False)
    (OUT / 'verification.json').write_text(json.dumps(result, indent=2, allow_nan=False) + '\n')
    print(json.dumps({k: result[k] for k in ('status', 'corrected_cpu_preserved', 'scientific_dataset_count', 'trigger_counts', 'comparison_status', 'scientific_gates_pass', 'archive_unchanged')}))
