...
The published integrated runtime has separate
:ref:`scientific qualification <torch-integrated-qualification>`, including
native tests and executable comparisons. It has no new timing campaign;
the measurements below retain their original source revisions.
