...
The latest matched timing campaign uses clean source
...
:ref:`torch-followup-evidence`. After restoring its optimization evidence
package, ``loader-v1/`` contains the frozen protocol, source/input/runtime pins
and acquisition helpers;
