...
def test_single_template_limits_only_torch_imrphenomd_generation(monkeypatch):
    for name in (
    ...
    cases = (
        ...
        (
            {
                "approximant": "IMRPhenomD", "mass1": 200.0,
                "mass2": 200.0,
            },
            {},
        ),
        ...
        (
            {
                "approximant": "IMRPhenomD", "mass1": 200.0,
                "mass2": 200.0, "f_final": 512.0,
            },
            {"f_final": 128.25},
        ),
        (
            {
                "approximant": "IMRPhenomD_NRTidalv2", "mass1": 1.4,
                "mass2": 1.3,
            },
            {},
        ),
        (
            {
                "approximant": "IMRPhenomD_NRTidalv2", "mass1": 1.4,
                "mass2": 1.3, "f_final": 512.0,
            },
            {"f_final": 512.0},
        ),
        (
            {
                "approximant": "TaylorF2", "mass1": 30.0,
                "mass2": 30.0, "f_final": 512.0,
            },
            {"f_final": 512.0},
        ),
    )
    with scheme.TorchScheme("cpu"):
        for parameters, expected_changes in cases:
            original = parameters.copy()
            single_template._limit_torch_imrphenomd_generation(
                parameters, flen=513, delta_f=0.25
            )
            assert parameters == original | expected_changes
    ...
    single_template._limit_torch_imrphenomd_generation(
        legacy, flen=513, delta_f=0.25
    )
    assert legacy["f_final"] == 512.0
