...
def test_cuda_graph_lifecycle_and_parity():
    ...
    ticket_eager = eager_engine.submit(
...
def test_cuda_graph_tail_tiles_variable_batch():
    ...
    ticket = engine.submit(data, psd_plan, valid_interval=(64, 448))
    res = engine.drain()
...
def test_cuda_graph_fallback_on_cpu():
    ...
    ticket = engine.submit(data, psd_plan, valid_interval=(32, 224))
    res = engine.drain()
