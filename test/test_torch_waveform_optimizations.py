...
def test_imrphenomd_batch_generation_and_parity():
    ...
    try:
        import pycbc.waveform.imrphenomd_torch
    except (ImportError, ModuleNotFoundError):
        pytest.skip("IMRPhenomD native port not available")
    with TorchScheme("cpu"):
        B = 4
...
def test_triton_imrphenomd_generation_and_fallback():
    ...
    try:
        ...
        pytest.skip("pycbc.waveform.triton.imrphenomd not available")
    params = {
        "approximant": "IMRPhenomD",
        "mass1": 30.0,
        "mass2": 20.0,
...
def test_triton_imrphenomxas_generation_and_fallback():
    ...
    try:
        ...
        pytest.skip("pycbc.waveform.triton.imrphenomxas not available")
    params = {
...
def test_triton_seobnr_ode_stepping_and_fallback():
    ...
    try:
        ...
        pytest.skip("pycbc.waveform.triton.seobnr_ode not available")
    def simple_rhs(t, y):
        return -0.5 * y
...
def test_cuda_graph_runner_approximants():
    ...
    try:
        ...
        pytest.skip("pycbc.waveform.cuda_graph_runner not available")
...
def test_vectorized_peak_finder():
    ...
    try:
        ...
        pytest.skip("pycbc.waveform.seobnrv4phm_peak not available")
...
def test_piecewise_regions_slicing():
    ...
    try:
        ...
        pytest.skip("pycbc.waveform.imrphenomd_torch not available")
...
def test_imrphenomxphm_numerical_parity():
    ...
    try:
        import pycbc.waveform.imrphenomxphm_torch
    except (ImportError, ModuleNotFoundError):
        pytest.skip("pycbc.waveform.imrphenomxphm_torch not available")
    with TorchScheme("cpu"):
        test_configs = [
            {
...
def test_imrphenomxp_numerical_parity():
    ...
    try:
        import pycbc.waveform.imrphenomxp_torch
    except (ImportError, ModuleNotFoundError):
        pytest.skip("pycbc.waveform.imrphenomxp_torch not available")
    with TorchScheme("cpu"):
        test_configs = [
            {
...
def test_seobnr_numerical_parity(monkeypatch):
    ...
    try:
        import pycbc.waveform.seobnrv4phm_torch
    except (ImportError, ModuleNotFoundError):
        pytest.skip("pycbc.waveform.seobnrv4phm_torch not available")
