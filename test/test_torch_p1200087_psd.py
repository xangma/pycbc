...
P1200087_MODELS = tuple(sorted(analytical_torch.P1200087_TORCH_ANALYTICAL_MODELS))
...
def test_p1200087_torch_family_matches_lalsimulation(
    ...
    expected = {
        model_name: _lal_psd(model_name, **parameters) for model_name in P1200087_MODELS
    }
...
def test_p1200087_preserves_real8_and_uses_static_torch_discovery(monkeypatch):
    model_name = "aLIGODesignSensitivityP1200087"
