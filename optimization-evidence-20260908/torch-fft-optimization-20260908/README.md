# torch-fft-optimization-20260908: publication evidence

Promoted CPU workspace and common frame-loader improvements qualified; CPU parity unmet. CUDA scalar scheduling showed a bounded warm-API benefit, without demonstrated executable gain in its separate campaign.
...
All successful and rejected CPU alternatives, superseded executable v1/v2 harness failures, executable v3, loader qualification/timing, warm CUDA diagnostics, native and local gates, peer reviews, source bundles and exact patches.

This package preserves **1065 of 1065 selected evidence files**
(167,131,044 original bytes) and all 2 original archives.
Only 42 interpreter-cache files are excluded, with individual hashes
...
All 202 entries of 11 frozen input/result
...
```sh
python3 -I verify.py
python3 -I verify.py --restore /absolute/fresh/parent/torch-fft-optimization-20260908
```
...
- [`loader-v1-summary.json`](readable/loader-v1-summary.json)
- [`loader-v1-metrics.csv`](readable/loader-v1-metrics.csv)
- [`executable-v3-summary.json`](readable/executable-v3-summary.json)
- [`cpu-timing-v5-summary.json`](readable/cpu-timing-v5-summary.json)
