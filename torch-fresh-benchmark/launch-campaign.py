"""Run fresh isolated qualifications and timings, then collect verified evidence."""
import hashlib
import json
...
config.update(description='Fresh complete-executable performance of current Torch main versus unchanged CPU.',
...
subprocess.run(['ssh','len','mkdir '+shlex.quote(REMOTE)],check=True)
