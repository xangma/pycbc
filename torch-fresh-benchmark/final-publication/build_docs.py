...
WORKTREE = Path('/private/tmp/pycbc-torch-benchmark-summary-20260908')
RUNTIME = args.runtime.resolve()
FROZEN = args.runtime_hash
DOC_BASE = 'eb8fef9ed1d06378b59cae8439fd40af63827575'
...
assert changed == ['docs/torch_performance.rst'], changed
...
(source / 'index.rst').write_text('Torch documentation\n================================\n\n.. toctree::\n   :maxdepth: 2\n\n   torch\n   waveform\n   waveform_plugin\n   install\n   api\n')
...
result = dict(command=command, returncode=code, pages=pages, runtime=provenance,
              ...
              source_mapping='One documentation-only change from PR15 eb8fef9e. API imports use the measured 88878b1c38 runtime, whose non-documentation tree is byte-identical to the cleaned main tree.',
