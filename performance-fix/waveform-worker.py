...
ROUTES = ("standard-cpu", "torch-cpu-scalar", "torch-cpu-batch",
          "torch-cuda-scalar", "torch-cuda-batch")
...
def run(a, r):
    ...
    r["capabilities"] = {
        ...
        "public_taylorf2_triton": True,
        "basis": "CPU/CUDA complex128; optional Triton is disabled in this baseline and measured separately",
    }
    r["dispatch"] = {"requested": a.route, "actual": None,
                     "triton_requested": False,
    ...
    if a.precision == "single":
        r["status"] = "unsupported"
        r["reason"] = "Public TaylorF2 CPU/CUDA outputs are complex128; no single precision selector"
        return
